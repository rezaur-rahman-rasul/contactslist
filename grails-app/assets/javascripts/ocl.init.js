...
jQuery(document).ready(function () {
    ...
    jQuery('.card-body').on('click', '.add-new-number ', function () {
        ...
        OCL.ajax.call({
            url: OCL.baseURL + "contactDetails/create",
            dataType: "html",
                ...
                confirm: {
                    ...
                    action: function () {
                        if(contactId !== undefined){
                            OCL.ajax.call({
                                url: OCL.baseURL + "contactDetails/delete/" + contactId,
                                success: function (content) {
                                    if(content.success === true){
                                        OCL.messageBox.showMessage(true, content.info);
                                        _this.closest(".form-group").remove();
                                    }else{
                                        OCL.messageBox.showMessage(false, content.info)
                                    }
                                }
                            });
                        }else{
